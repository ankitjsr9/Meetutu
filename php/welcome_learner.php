    ...
    <body>
        ...
        <script>
            ...
            var geojson = {
                ...
                features: [
                    <?php   $poss = $_SERVER["DOCUMENT_ROOT"]."/database/"; include($poss."java_input_teacher.txt");   ?>
                ]};
            geojson.features.forEach(function(marker) {
                ...
                new mapboxgl.Marker(el)
                    ...
                    .setPopup(new mapboxgl.Popup({ offset: 25 }) // add popups
                              .setHTML("<h3><a href='personal_info_teacher.php?email_id=" + marker.properties.email_id + "'>" + marker.properties.title + "</a></h3><p style='font-size:13px;'>Area of specialization : " + marker.properties.description + "<br>Experience of : " + marker.properties.expe + " Years</p>"))
                    .addTo(map);
            });
        </script> 
